...
TRANSLATIONS = {
    "EN": {
        ...
        "clear": "Clear", "steps": "clicks",
        "pattern_hint": "Press Record, then click the screen in the order you want repeated. Press Finish when you are done. Clicks on this window are not recorded.",
    ...
    "TR": {
        ...
        "clear": "Temizle", "steps": "tık",
        "pattern_hint": "Kaydet'e bas, sonra tekrarlanmasını istediğin sırayla ekrana tıkla. Bitince Bitir'e bas. Bu pencereye yapılan tıklamalar kaydedilmez.",
    ...
    "DE": {
        ...
        "clear": "Loschen", "steps": "Klicks",
        "pattern_hint": "Auf Aufnehmen drucken, dann in der gewunschten Reihenfolge auf den Bildschirm klicken. Danach Fertig drucken. Klicks auf dieses Fenster werden nicht aufgenommen.",
    ...
    "ES": {
        ...
        "clear": "Borrar", "steps": "clics",
        "pattern_hint": "Pulsa Grabar y haz clic en la pantalla en el orden que quieras repetir. Pulsa Listo al terminar. Los clics en esta ventana no se graban.",
    ...
    "FR": {
        ...
        "clear": "Effacer", "steps": "clics",
        "pattern_hint": "Appuyez sur Enregistrer, puis cliquez a l'ecran dans l'ordre a repeter. Appuyez sur Termine ensuite. Les clics sur cette fenetre ne sont pas enregistres.",
    ...
    "ZH": {
        ...
        "clear": "Qing Chu", "steps": "ci",
        "pattern_hint": "An Lu Zhi, Ran Hou An Xu Yao Chong Fu De Shun Xu Dian Ji Ping Mu. Wan Cheng Hou Zai An Yi Ci. Dian Ji Ben Chuang Kou Bu Hui Bei Lu Zhi.",
