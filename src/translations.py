...
TRANSLATIONS = {
    "EN": {
        ...
        "pattern_hint": "Press Record or the Rec key, then click the screen in order. The same key ends it, so this window is never in the way. Clicks on it and on the taskbar are never recorded.",
    ...
    "TR": {
        ...
        "pattern_hint": "Kaydet'e ya da Kayıt kısayoluna bas, sonra sırayla ekrana tıkla. Aynı kısayol kaydı bitirir. Bu pencereye ve görev çubuğuna yapılan tıklamalar kaydedilmez.",
    ...
    "DE": {
        ...
        "pattern_hint": "Auf Aufnehmen oder die Aufnahmetaste drucken, dann der Reihe nach klicken. Dieselbe Taste beendet sie. Klicks auf dieses Fenster und die Taskleiste werden nie aufgenommen.",
    ...
    "ES": {
        ...
        "pattern_hint": "Pulsa Grabar o tu tecla de grabacion y haz clic en orden. La misma tecla lo termina. Los clics en esta ventana y en la barra de tareas nunca se graban.",
    ...
    "FR": {
        ...
        "pattern_hint": "Appuyez sur Enregistrer ou sur votre touche d'enregistrement, puis cliquez dans l'ordre. La meme touche termine. Les clics sur cette fenetre et la barre des taches ne sont jamais enregistres.",
